...
Age	int	Numerical	Age of the employee
Attrition	object	Categorical	Indicates whether the employee left the company
BusinessTravel	object	Categorical	Frequency of business travel
DailyRate	int	Numerical	Daily wage rate
Department	object	Categorical	Department the employee belongs to
DistanceFromHome	int	Numerical	Distance between home and workplace
Education	int	Numerical	Education level
EducationField	object	Categorical	Field of education
EmployeeCount	int	Numerical	Employee count (constant)
EmployeeNumber	int	Numerical	Unique employee identifier
EnvironmentSatisfaction	int	Numerical	Satisfaction with work environment
Gender	object	Categorical	Gender of the employee
HourlyRate	int	Numerical	Hourly wage
JobInvolvement	int	Numerical	Level of job involvement
JobLevel	int	Numerical	Job level within the company
JobRole	object	Categorical	Role/designation
JobSatisfaction	int	Numerical	Job satisfaction score
MaritalStatus	object	Categorical	Marital status
MonthlyIncome	int	Numerical	Monthly income
MonthlyRate	int	Numerical	Monthly compensation rate
NumCompaniesWorked	int	Numerical	Number of companies previously worked at
Over18	object	Categorical	Whether employee is over 18
OverTime	object	Categorical	Whether employee works overtime
PercentSalaryHike	int	Numerical	Percentage salary hike
PerformanceRating	int	Numerical	Performance rating
RelationshipSatisfaction	int	Numerical	Relationship satisfaction score
StandardHours	int	Numerical	Standard working hours
StockOptionLevel	int	Numerical	Stock option level
TotalWorkingYears	int	Numerical	Total years of experience
TrainingTimesLastYear	int	Numerical	Training sessions last year
WorkLifeBalance	int	Numerical	Work-life balance rating
YearsAtCompany	int	Numerical	Years spent at the company
YearsInCurrentRole	int	Numerical	Years in current role
YearsSinceLastPromotion	int	Numerical	Years since last promotion
YearsWithCurrManager	int	Numerical	Years with current manager
...
📊 Dashboard 2: Attrition & Satisfaction Analysis
